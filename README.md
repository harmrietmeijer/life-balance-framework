...
| Pillar | What it measures | Key areas |
|--------|-----------------|----------|
| 🟢 **Happy** | Emotional & social wellbeing | Relationships, purpose, joy, stress management, mindfulness |
| 🟣 **Healthy** | Physical & mental health | Exercise, nutrition, sleep, energy, mental resilience |
| 🟠 **Wealthy** | Financial & professional growth | Income, savings, career development, financial security, skills |
...
### 🟢 Happy (Emotional & Social Wellbeing)

| # | Question | Your Score (1-10) |
|---|----------|------------------|
| 1 | I feel a sense of purpose and meaning in my daily life | |
| 2 | I have strong, supportive relationships | |
| 3 | I manage stress effectively | |
| 4 | I experience joy and gratitude regularly | |
| 5 | I feel connected to a community | |

**Your Happy Score:** Add your scores and divide by 5 = ___

### 🟣 Healthy (Physical & Mental Health)

| # | Question | Your Score (1-10) |
|---|----------|------------------|
| 1 | I exercise regularly (3+ times per week) | |
| 2 | I sleep well and wake up feeling rested | |
| 3 | I eat nutritious meals consistently | |
| 4 | I have good energy throughout the day | |
| 5 | I take care of my mental health | |

**Your Healthy Score:** Add your scores and divide by 5 = ___

### 🟠 Wealthy (Financial & Professional Growth)

| # | Question | Your Score (1-10) |
|---|----------|------------------|
| 1 | I feel financially secure | |
| 2 | I'm growing professionally or building valuable skills | |
| 3 | I have a clear plan for my financial future | |
| 4 | My work aligns with my values and strengths | |
| 5 | I'm building assets or income streams | |

**Your Wealthy Score:** Add your scores and divide by 5 = ___

### Calculate Your Life Balance Score

```
Life Balance Score = (Happy + Healthy + Wealthy) / 3
```
...
The framework draws on several evidence-based approaches:

- **PERMA Model** (Martin Seligman) — Positive emotions, Engagement, Relationships, Meaning, Achievement
- **COM-B Framework** — Capability, Opportunity, Motivation drive Behavior change
...
Once you know your scores, use this weekly practice:

1. **Score** — Rate your three pillars every Sunday evening (2 minutes)
2. **Spot** — Identify which pillar dropped or needs attention
3. **Select** — Choose ONE small action for that pillar this week
4. **Start** — Attach it to an existing habit (habit stacking)
5. **Score again** — Track your progress next Sunday

### Example micro-actions by pillar

**🟢 Happy:** Send one appreciation message per day. Journal for 2 minutes before bed. Call a friend you haven't spoken to in a month.

**🟣 Healthy:** Take a 10-minute walk after lunch. Drink water before coffee. Set a bedtime alarm.
...
This framework is open source and community-driven. We welcome:

- Additional self-assessment questions backed by research
...
This framework is released under the [MIT License](LICENSE). Use it, share it, adapt it.

The Life Balance Framework is maintained by the team behind [nuvo.coach](https://nuvo.coach) — an AI-powered life coaching platform helping people live happier, healthier, and wealthier lives.

---

*"You can't improve what you don't measure. Start with your Life Balance Score."*
